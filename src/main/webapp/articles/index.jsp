...
<div class="mt-4 flex justify-center">
    <form action="<%=request.getContextPath()%>/articles?action=search" method="get" class="relative w-full md:w-1/2">
        ...
        <button type="submit"
                class="absolute inset-y-0 right-0 px-4 py-2 bg-black text-white rounded-r-md hover:bg-gray-800">Search
        </button>
    </form>
</div>
...
<main class="max-w-7xl mx-auto mt-8 px-4">
    <div class="flex justify-between items-center mb-4">
        ...
        <button onclick="openModal()" class="bg-black text-white px-4 py-2 rounded hover:bg-gray-800">+ Add Article
        </button>
    </div>

    <!-- Article Cards Grid -->
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <!-- Iterate over the articleWithCommentCounts map -->
        <c:forEach var="entry" items="${articleWithCommentCounts}">
            ...
            <div class="bg-white p-4 rounded shadow-md border">
                ...
                <p class="text-gray-500 text-sm mt-2">
                    <span class="font-bold">Comments: </span> ${commentCount}
                </p>
...
<div id="addArticleModal" class="fixed inset-0 bg-gray-800 bg-opacity-75 flex justify-center items-center hidden">
    <div class="bg-white rounded-lg shadow-lg w-1/3 p-6">
        ...
        <form id="addArticleForm" action="<%=request.getContextPath()%>/articles?action=insert" method="post"
            ...
            <div class="flex justify-end space-x-2">
                ...
                <button type="submit" class="px-4 py-2 bg-black text-white rounded-md hover:bg-gray-800">Add Article
                </button>
            </div>
        </form>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-lg w-1/3 p-6">
        ...
        <div class="flex justify-end space-x-2">
            <button type="button" onclick="closeErrorModal()"
                    class="px-4 py-2 bg-gray-400 text-white rounded-md hover:bg-gray-500">Close
            </button>
        </div>
    </div>
</div>
...
<script>
    ...
    function validateForm() {
        ...
        // Validate title (1 to 100 alphanumeric characters)
        ...
        // Validate content (1 to 500 characters)
